...
\documentclass[cn,screen,17pt,blue]{elegantnote}
...
\geometry{top=1.0cm,bottom=1.6cm,footskip=1.0cm}
%\geometry{top=1.0cm,bottom=1.8cm,footskip=1.5cm}

\renewcommand{\cftsecaftersnumb}{\hspace{0.5em}}
\renewcommand{\cftsubsecaftersnumb}{\hspace{0.5em}}
...
\fancypagestyle{plain}{
  \fancyhf{}
  \fancyfoot[R]{\footnotesize\textcolor{ecolor}{\thepage}}
}
...
\begin{titlepage}
    ...
    %\scshape
    \vspace*{0.5\baselineskip}   % 页面顶部的空白
    \color{ecolor}
    ...
    \vspace{0.5\baselineskip} % 标题上方的空白
	...
	\vspace{0.5\baselineskip} % 标题下方的空白
...
%\bibitem{Tadmor2012} Tadmor~E. A review of numerical methods for nonlinear
%partial differential equations\allowbreak[J]. Bull. Amer. Math. Soc., 2012, 49(4): 507-554.
%
...
%
%\bibitem{Shen1994} Shen~J. Efficient spectral-Galerkin method I. Direct solvers of second- and fourth-order equations using
%Legendre polynomials\allowbreak[J]. SIAM J. Sci. Comput., 1994, 15(6): 1489-1505.
%
%\end{thebibliography}
